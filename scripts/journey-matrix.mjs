...
const variants = process.argv.includes('--adversarial')
  ? [{ manualBuildOut: true }, { useSupplyRuns: true }, { developmentFocus: 'research' }, { branch: 'reverse' }, { branch: 'random' }, { useRecovery: true, disableProtection: true }, { inefficient: true }, { badLuck: true },
