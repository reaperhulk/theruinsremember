...
export const upgrades = {
  ...
  // Era 1
  charcoalKiln: { id: 'charcoalKiln', name: 'Charcoal Kiln', era: 1, cost: { materials: 22, energy: 12, labor: 14 }, effects: [{ type: 'production_mult', target: 'energy', value: 2 }, { type: 'production_add', target: 'materials', value: 0.5 }], description: 'Burn wood into charcoal for efficient fuel', prerequisites: ['basicPower'] },
  grainSilo: { id: 'grainSilo', name: 'Grain Silo', era: 1, cost: { food: 28, materials: 20, labor: 10 }, effects: [{ type: 'cap_mult', target: 'food', value: 3 }, { type: 'production_add', target: 'food', value: 0.4 }], description: 'Store surplus grain for lean seasons', prerequisites: ['irrigation'] },
  ...
  chemicalPlant: { id: 'chemicalPlant', name: 'Chemical Plant', era: 2, cost: { steel: 18, energy: 22, research: 10 }, effects: [{ type: 'production_mult', target: 'energy', value: 2 }, { type: 'production_add', target: 'research', value: 0.5 }], description: 'Chemical processes double energy and boost research', prerequisites: ['powerGrid'] },
  printingPress: { id: 'printingPress', name: 'Printing Press', era: 2, cost: { materials: 16, electronics: 12, labor: 15 }, effects: [{ type: 'production_mult', target: 'research', value: 2 }, { type: 'production_add', target: 'electronics', value: 0.3 }], description: 'Mass printing doubles research output', prerequisites: ['computingLab'] },

  // Era 3
  neuralNetwork: { id: 'neuralNetwork', name: 'Neural Network', era: 3, cost: { software: 28, data: 22, research: 30 }, effects: [{ type: 'production_mult', target: 'data', value: 3 }, { type: 'production_add', target: 'research', value: 0.6 }], description: 'Deep learning triples data processing', prerequisites: ['aiResearch'] },
  edgeComputing: { id: 'edgeComputing', name: 'Edge Computing', era: 3, cost: { electronics: 30, software: 18, data: 14 }, effects: [{ type: 'production_mult', target: 'electronics', value: 2 }, { type: 'production_mult', target: 'software', value: 2 }], description: 'Distributed edge nodes double electronics and software', prerequisites: ['cloudComputing'] },
  blockchainLedger: { id: 'blockchainLedger', name: 'Blockchain Ledger', era: 3, cost: { data: 25, software: 20, energy: 18 }, effects: [{ type: 'production_mult', target: 'data', value: 2 }, { type: 'cap_mult', target: 'data', value: 2 }], description: 'Immutable ledger doubles data output and capacity', prerequisites: ['internet'] },
  ...
  xenoBotany: { id: 'xenoBotany', name: 'Xeno-Botany Lab', era: 6, cost: { colonies: 8, research: 55, food: 60 }, effects: [{ type: 'production_mult', target: 'colonies', value: 2 }, { type: 'production_mult', target: 'food', value: 5 }], description: 'Alien plants sustain colonies and multiply food', prerequisites: ['alienDiplomacy'] },
  graviticLoom: { id: 'graviticLoom', name: 'Gravitic Loom', era: 6, cost: { exoticMaterials: 35, darkEnergy: 25, starSystems: 5 }, effects: [{ type: 'production_mult', target: 'exoticMaterials', value: 3 }, { type: 'production_add', target: 'darkEnergy', value: 0.3 }], description: 'Weave exotic materials using gravitational fields', prerequisites: ['darkEnergyCollector'] },
  ...
  voidHarvester: { id: 'voidHarvester', name: 'Void Harvester', era: 8, cost: { exoticMatter: 35, darkEnergy: 50, starSystems: 100 }, effects: [{ type: 'production_mult', target: 'darkEnergy', value: 3 }, { type: 'production_mult', target: 'exoticMatter', value: 2 }], description: 'Harvest the void between galaxies', prerequisites: ['matterReplicators'] },
  ...
  // Era 10
  infinityWell: { id: 'infinityWell', name: 'Infinity Well', era: 10, cost: { quantumEchoes: 85, realityFragments: 105, universalConstants: 24 }, effects: [{ type: 'production_mult', target: 'quantumEchoes', value: 5 }, { type: 'production_mult', target: 'universalConstants', value: 3 }], description: 'Draw from the infinite well of possibility', prerequisites: ['dimensionalAnchors'] },
  ...
  multiversalNexus: { id: 'multiversalNexus', name: 'Multiversal Nexus', era: 10, cost: { realityFragments: 150, universalConstants: 30, quantumEchoes: 100 }, effects: [{ type: 'production_mult', target: 'realityFragments', value: 10 }, { type: 'production_mult', target: 'cosmicPower', value: 5 }], description: 'A nexus connecting all realities — x10 fragments and x5 cosmic power', prerequisites: ['realityWeaving'] },
};
