...
export const upgrades = {
  ...
  // Era 2
  telegraphNetwork: { id: 'telegraphNetwork', name: 'Telegraph Network', era: 2, cost: { electronics: 25, steel: 30, research: 15 }, effects: [{ type: 'production_mult', target: 'electronics', value: 2 }, { type: 'production_add', target: 'research', value: 0.5 }], description: 'Long-distance communication accelerates industry', prerequisites: ['computingLab'] },
  steamTurbine: { id: 'steamTurbine', name: 'Steam Turbine', era: 2, cost: { steel: 40, energy: 35, labor: 20 }, effects: [{ type: 'production_mult', target: 'energy', value: 3 }, { type: 'production_add', target: 'steel', value: 0.5 }], description: 'High-pressure steam generates massive energy', prerequisites: ['powerGrid'] },
  cementFactory: { id: 'cementFactory', name: 'Cement Factory', era: 2, cost: { materials: 35, steel: 20, energy: 25 }, effects: [{ type: 'production_mult', target: 'materials', value: 3 }, { type: 'cap_mult', target: 'steel', value: 2 }], description: 'Mass-produce cement for construction — triple materials', prerequisites: ['assemblyLines'] },
  ...
  cyberSecurity: { id: 'cyberSecurity', name: 'Cyber Security', era: 3, cost: { software: 25, research: 20, data: 15 }, effects: [{ type: 'cap_mult', target: 'data', value: 3 }, { type: 'production_add', target: 'software', value: 0.5 }], description: 'Protect data assets — triple data capacity', prerequisites: ['internet'] },
  neuralProcessor: { id: 'neuralProcessor', name: 'Neural Processor', era: 3, cost: { research: 35, electronics: 30, data: 25 }, effects: [{ type: 'production_mult', target: 'research', value: 3 }, { type: 'production_add', target: 'data', value: 0.8 }], description: 'Brain-inspired chips triple research output', prerequisites: ['quantumComputer'] },

  // Era 4
  ionDrive: { id: 'ionDrive', name: 'Ion Drive', era: 4, cost: { rocketFuel: 50, research: 60, energy: 80 }, effects: [{ type: 'production_mult', target: 'rocketFuel', value: 2 }, { type: 'production_add', target: 'orbitalInfra', value: 0.3 }], description: 'Efficient ion propulsion doubles fuel efficiency', prerequisites: ['deepSpaceRelay'] },
  lunarBase: { id: 'lunarBase', name: 'Lunar Base', era: 4, cost: { orbitalInfra: 20, materials: 80, steel: 60 }, effects: [{ type: 'production_mult', target: 'orbitalInfra', value: 2 }, { type: 'cap_mult', target: 'orbitalInfra', value: 3 }], description: 'A permanent moon base doubles orbital production', prerequisites: ['orbitalForge'] },
  solarArray: { id: 'solarArray', name: 'Orbital Solar Array', era: 4, cost: { energy: 100, orbitalInfra: 15, electronics: 50 }, effects: [{ type: 'production_mult', target: 'energy', value: 5 }, { type: 'production_add', target: 'research', value: 1 }], description: 'Massive solar panels in orbit — x5 energy', prerequisites: ['asteroidTug'] },

  // Era 5
  terraformingEngine: { id: 'terraformingEngine', name: 'Terraforming Engine', era: 5, cost: { colonies: 10, exoticMaterials: 40, energy: 200 }, effects: [{ type: 'production_mult', target: 'colonies', value: 3 }, { type: 'production_add', target: 'food', value: 5 }], description: 'Transform barren worlds into habitable colonies', prerequisites: ['cryoHabitat'] },
  fusionReactor: { id: 'fusionReactor', name: 'Fusion Reactor', era: 5, cost: { energy: 300, exoticMaterials: 50, research: 100 }, effects: [{ type: 'production_mult', target: 'energy', value: 5 }, { type: 'production_add', target: 'exoticMaterials', value: 0.3 }], description: 'Stable fusion provides boundless energy — x5 output', prerequisites: ['antimatterCollider'] },
  gravityWell: { id: 'gravityWell', name: 'Gravity Well Generator', era: 5, cost: { exoticMaterials: 60, research: 80, rocketFuel: 80 }, effects: [{ type: 'production_mult', target: 'exoticMaterials', value: 3 }, { type: 'cap_mult', target: 'exoticMaterials', value: 3 }], description: 'Generate artificial gravity wells to collect exotic materials', prerequisites: ['gravitySmelter'] },

  // Era 6
  warpGate: { id: 'warpGate', name: 'Warp Gate', era: 6, cost: { starSystems: 6, darkEnergy: 40, research: 80 }, effects: [{ type: 'production_mult', target: 'starSystems', value: 3 }, { type: 'production_add', target: 'darkEnergy', value: 0.5 }], description: 'Instant travel between star systems — x3 colonization speed', prerequisites: ['stellarCartography'] },
  darkMatterLens: { id: 'darkMatterLens', name: 'Dark Matter Lens', era: 6, cost: { darkEnergy: 50, energy: 150, research: 60 }, effects: [{ type: 'production_mult', target: 'darkEnergy', value: 3 }, { type: 'production_mult', target: 'energy', value: 3 }], description: 'Focus dark matter into a lens — triple dark energy and energy', prerequisites: ['darkEnergyRefinery'] },
  ...
  // Era 8
  galacticSenate: { id: 'galacticSenate', name: 'Galactic Senate', era: 8, cost: { galacticInfluence: 200, exoticMatter: 80, starSystems: 50 }, effects: [{ type: 'production_mult', target: 'galacticInfluence', value: 3 }, { type: 'cap_mult', target: 'galacticInfluence', value: 3 }], description: 'Establish a senate to govern the galaxy — x3 influence', prerequisites: ['influenceBeacon'] },
  ...
  entropyEngine: { id: 'entropyEngine', name: 'Entropy Engine', era: 9, cost: { cosmicPower: 220, realityFragments: 15, megastructures: 25 }, effects: [{ type: 'production_mult', target: 'cosmicPower', value: 2 }, { type: 'production_mult', target: 'exoticMatter', value: 3 }], description: 'Harness entropy itself as a power source', prerequisites: ['entropyShield'] },
