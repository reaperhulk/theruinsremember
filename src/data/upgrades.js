...
export const upgrades = {
  ...
  warpDrive: {
    ...
    effects: [{ type: 'production_add', target: 'starSystems', value: 1.5 }, { type: 'production_add', target: 'darkEnergy', value: 1.0 }, { type: 'production_mult', target: 'starSystems', value: 5 }, { type: 'production_mult', target: 'darkEnergy', value: 3 }, { type: 'cap_mult', target: 'starSystems', value: 3 }, { type: 'cap_mult', target: 'darkEnergy', value: 3 }],
  ...
  stellarCartography: {
    ...
    cost: { starSystems: 1, research: 60, data: 30 },
    effects: [{ type: 'production_mult', target: 'starSystems', value: 3 }, { type: 'production_add', target: 'darkEnergy', value: 0.5 }],
  ...
  wormholeNetwork: {
    ...
    effects: [
      ...
      { type: 'production_add', target: 'exoticMatter', value: 0.8 },
      { type: 'production_add', target: 'galacticInfluence', value: 0.5 },
  ...
  realityLoom: {
    ...
    description: 'Each loom pulls thread from a reality that unraveled — the fragments remember being whole, and they want to be woven again',
    prerequisites: ['realityWeaving'],
    repeatable: true,
    costScale: 1.5,
  },
  ...
  dimensionalRift: {
    ...
    description: 'Each rift opens onto a version of you that finished first — their echoes carry instructions for how to catch up',
    prerequisites: ['dimensionalAnchors'],
    repeatable: true,
    costScale: 1.5,
  },
  ...
  // Era 9
  singularityDrive: { id: 'singularityDrive', name: 'Singularity Drive', era: 9, cost: { cosmicPower: 90, universalConstants: 8, exoticMatter: 40 }, effects: [{ type: 'production_add', target: 'cosmicPower', value: 12 }, { type: 'production_add', target: 'exoticMatter', value: 6 }], description: 'The drive feeds on collapsed stars — each singularity a keyhole into the engine room of reality, where the cycle\'s machinery hums', prerequisites: ['cosmicSentinel'] },
  dimensionalScanner: { id: 'dimensionalScanner', name: 'Dimensional Scanner', era: 9, cost: { universalConstants: 10, cosmicPower: 70, darkEnergy: 50 }, effects: [{ type: 'production_add', target: 'universalConstants', value: 6 }, { type: 'production_add', target: 'realityFragments', value: 0.1 }], description: 'The scanner peers through the walls of reality and finds your own face looking back — every adjacent dimension contains a version of this moment', prerequisites: ['galaxyMapper'] },
  ...
  quantumLattice: { id: 'quantumLattice', name: 'Quantum Lattice', era: 10, cost: { quantumEchoes: 75, realityFragments: 100, universalConstants: 22 }, effects: [{ type: 'production_add', target: 'quantumEchoes', value: 40 }, { type: 'production_add', target: 'universalConstants', value: 20 }], description: 'The lattice crystallizes from echoes that were always in phase — a scaffold of certainty in a sea of quantum noise, built from memories of every outcome', prerequisites: ['parallelProcessing', 'dimensionalAnchors'] },
  ...
  stellarHarvester: {
    ...
    description: 'Ancient harvesters awaken at your signal. Every 30s recover four seconds of production, rotating between research, energy, and software, including while offline.',
  ...
  infiniteLoop: {
    ...
    description: 'The cycle completes. The cycle begins. All production doubles, with an additional 0.1% resonance bonus.',
