...
export const upgrades = {
  ...
  scavengerInstinct: {
    ...
    description: 'The ruins left everything connected. Tug one thread and supplies appear everywhere. Every click scavenges +1 of every other unlocked resource.',
  ...
  surplusExchange: {
    ...
    description: 'The precursors wasted nothing. Their distribution channels still work — surplus flows to wherever need is greatest. Resources at cap convert to your lowest resource.',
  ...
  communalEffort: {
    ...
    description: 'Each recovered technique sparks another. The ruins rewarded cooperation — the more you rebuild, the faster everything grows. +0.5% production per upgrade owned (max +50%).',
  ...
  overclockProtocol: {
    ...
    description: 'Buried circuitry pulses with a rhythm that predates your arrival. Ride its frequency: all production doubles for 10s every 60s.',
  ...
  resourcePipeline: {
    ...
    description: 'The old pipeline network routes excess everywhere at once. When resources hit cap, 10% of overflow converts to research.',
  ...
  chainReaction: {
    ...
    description: 'Each discovery unlocks a cascade buried in the ruins. Every upgrade purchased triggers a burst of 5s worth of all resources.',
    prerequisites: ['computingLab'],
  ...
  recursiveOptimizer: {
    ...
    description: 'The code rewrites itself, improving with each cycle — like it remembers being optimized before. Each era multiplies all production by 1.1x.',
  ...
  dataMining: {
    ...
    description: 'The databases were sealed, not destroyed. Fragments surface when disturbed. 20% chance on any click to find a data cache worth 30s of production.',
  ...
  orbitalResonance: {
    ...
    effects: [{ type: 'production_add', target: 'orbitalInfra', value: 1.0 }],
    description: 'Orbital platforms harmonize like instruments in a precursor orchestra. Each mini-game you\'ve engaged adds +10% to all production.',
  ...
  launchWindow: {
    ...
    effects: [{ type: 'production_add', target: 'rocketFuel', value: 1.5 }],
    description: 'The launch windows align with ancient orbital rhythms. Docking perfects now boost ALL production by 5% for 30 seconds.',
  ...
  terraformSync: {
    ...
    description: 'Colonies sync with the terraformed biomes left by the precursors. Assignments multiply their target resources by 1.5x.',
  ...
  stellarHarvester: {
    ...
    description: 'Ancient harvesters awaken at your signal — they were waiting to resume. Deposits are gathered every 5s without clicking.',
  ...
  warpEcho: {
    ...
    description: 'Star routes trace grooves worn into spacetime by a thousand prior voyages. Each route adds +3% to all production.',
    prerequisites: ['warpDrive', 'stellarCartography'],
    mechanic: 'routeBonus',
  },
  ...
  forgeMemory: {
    ...
    description: 'The forge\'s memory banks contain schematics from previous cycles — every hack unlocks another. Hacking successes permanently boost a random resource by 1%.',
    prerequisites: ['dysonSphere', 'starLifting'],
