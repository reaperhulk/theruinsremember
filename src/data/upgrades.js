...
export const upgrades = {
  ...
  quarry: { id: 'quarry', name: 'Quarry', era: 1, cost: { labor: 18, materials: 15, energy: 10 }, effects: [{ type: 'production_mult', target: 'materials', value: 2 }, { type: 'cap_mult', target: 'materials', value: 3 }], description: 'Stone quarry doubles material output and triples capacity', prerequisites: ['tools'] },

  // Era 2
  chemicalPlant: { id: 'chemicalPlant', name: 'Chemical Plant', era: 2, cost: { steel: 22, energy: 18, research: 10 }, effects: [{ type: 'production_mult', target: 'energy', value: 2 }, { type: 'production_add', target: 'research', value: 0.3 }], description: 'Chemical processing doubles energy and enables early research', prerequisites: ['powerGrid'] },
  ...
  virtualReality: { id: 'virtualReality', name: 'Virtual Reality', era: 3, cost: { software: 22, data: 18, electronics: 15 }, effects: [{ type: 'production_mult', target: 'software', value: 2 }, { type: 'production_mult', target: 'research', value: 2 }], description: 'VR simulations double software and research output', prerequisites: ['openSource'] },
  ...
  solarSail: { id: 'solarSail', name: 'Solar Sail', era: 4, cost: { electronics: 18, rocketFuel: 12, research: 20 }, effects: [{ type: 'production_mult', target: 'energy', value: 2 }, { type: 'production_mult', target: 'rocketFuel', value: 2 }], description: 'Solar sails double energy and fuel efficiency', prerequisites: ['solarArrays'] },
  ...
  // Era 9
  realityScanner: { id: 'realityScanner', name: 'Reality Scanner', era: 9, cost: { universalConstants: 10, cosmicPower: 80, realityFragments: 4 }, effects: [{ type: 'production_add', target: 'realityFragments', value: 0.3 }, { type: 'production_mult', target: 'research', value: 5 }], description: 'Scan adjacent realities — fragments and x5 research from alien physics', prerequisites: ['entropyReversal'] },
