...
export const techTree = {
  ...
  frontierAccords: {
    id: 'frontierAccords', name: 'Frontier Accords', era: 6,
    cost: { starSystems: 35, darkEnergy: 220, colonies: 18 },
    prerequisites: ['galacticCartography'],
    grantsEra: null,
    description: 'Expansion first. The frontier exists to be settled before anything else can claim it',
    effects: [
      { type: 'production_mult', target: 'starSystems', value: 2 },
      { type: 'production_add', target: 'colonies', value: 4 },
      { type: 'production_add', target: 'exoticMaterials', value: 2 },
    ],
    excludes: 'signalArchaeology',
  },
  signalArchaeology: {
    id: 'signalArchaeology', name: 'Signal Archaeology', era: 6,
    cost: { research: 70000, darkEnergy: 240, data: 6000 },
    prerequisites: ['galacticCartography'],
    grantsEra: null,
    description: 'Interpret the dead beacons instead of outrunning them. Memory becomes a navigational resource',
    effects: [
  ...
  imperialMandate: {
    id: 'imperialMandate', name: 'Imperial Mandate', era: 8,
    cost: { galacticInfluence: 18000, exoticMatter: 600, colonies: 180 },
    prerequisites: ['cosmicEngineering'],
    grantsEra: null,
    description: 'Centralize the galaxy under a single command structure. Order buys reach at the cost of flexibility',
    effects: [
      { type: 'production_mult', target: 'galacticInfluence', value: 2.5 },
      { type: 'production_add', target: 'cosmicPower', value: 2 },
      { type: 'production_add', target: 'colonies', value: 10 },
    ],
    excludes: 'distributedSynod',
  },
  distributedSynod: {
    id: 'distributedSynod', name: 'Distributed Synod', era: 8,
    cost: { galacticInfluence: 12000, exoticMatter: 700, research: 350000 },
    prerequisites: ['cosmicEngineering'],
    grantsEra: null,
    description: 'Let countless local intelligences steer the galaxy. Adaptation beats control, but consensus is slower',
    effects: [
      { type: 'production_mult', target: 'exoticMatter', value: 2.5 },
      { type: 'production_mult', target: 'research', value: 1.8 },
      { type: 'production_add', target: 'galacticInfluence', value: 8 },
    ],
    excludes: 'imperialMandate',
  },
  intergalacticBeacon: {
  ...
  constantLattice: {
    id: 'constantLattice', name: 'Constant Lattice', era: 9,
    cost: { universalConstants: 30, cosmicPower: 8000, exoticMatter: 400 },
    prerequisites: ['realityScience'],
    grantsEra: null,
    description: 'Pin reality in place and force the multiverse to negotiate on your terms',
    effects: [
      { type: 'production_mult', target: 'universalConstants', value: 2.5 },
      { type: 'production_add', target: 'cosmicPower', value: 12 },
      { type: 'cap_mult', target: 'universalConstants', value: 2 },
    ],
    excludes: 'fracturedBloom',
  },
  fracturedBloom: {
    id: 'fracturedBloom', name: 'Fractured Bloom', era: 9,
    cost: { realityFragments: 30, cosmicPower: 9000, research: 5000000 },
    prerequisites: ['realityScience'],
    grantsEra: null,
    description: 'Let the seams spread and harvest what spills through. Instability becomes abundance',
    effects: [
      { type: 'production_mult', target: 'realityFragments', value: 3 },
      { type: 'production_add', target: 'realityFragments', value: 8 },
      { type: 'production_add', target: 'universalConstants', value: 3 },
    ],
    excludes: 'constantLattice',
  },
  multiverseDetection: {
