...
export const techTree = {
  ...
  agrarianFocus: {
    ...
    grantsEra: null,
    description: 'Invest in sustainable farming — x3 food cap, x2 food production, x1.5 labor production',
  ...
  miningFocus: {
    ...
    prerequisites: ['metallurgy'],
    grantsEra: null,
    description: 'Invest in extraction — x3 materials cap, x2 materials production, x1.5 energy production',
  ...
  heavyIndustry: {
    ...
    grantsEra: null,
    description: 'Focus on manufacturing — x3 steel cap, x2 steel production, x1.5 materials production',
  ...
  electronicsRevolution: {
    ...
    prerequisites: ['advancedComputing'],
    grantsEra: null,
    description: 'Focus on tech — x3 electronics cap, x2 electronics production, x1.5 research production',
  ...
  openSourceMovement: {
    ...
    grantsEra: null,
    description: 'Community-driven development — x3 software cap, x3 software production, x2 research production',
  ...
  corporateData: {
    ...
    prerequisites: ['globalNetwork'],
    grantsEra: null,
    description: 'Proprietary data collection — x3 data cap, x3 data production, x2 electronics production',
  ...
  rocketSupremacy: {
    ...
    grantsEra: null,
    description: 'Brute force approach — x3 rocket fuel cap, x3 rocketFuel production, x2 steel production',
  ...
  orbitalElegance: {
    ...
    prerequisites: ['interplanetaryNav'],
    grantsEra: null,
    description: 'Efficient infrastructure — x3 orbital infra cap, x3 orbitalInfra production, x2 research production',
