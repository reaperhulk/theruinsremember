...
export const techTree = {
  ...
  hydroponics: { id: 'hydroponics', name: 'Hydroponics', era: 1, cost: { food: 35, materials: 20, labor: 15 }, prerequisites: ['metallurgy'], grantsEra: null, description: 'Soilless farming triples food and doubles energy output', effects: [{ type: 'production_mult', target: 'food', value: 3 }, { type: 'production_mult', target: 'energy', value: 2 }] },
  fusionMiniaturization: { id: 'fusionMiniaturization', name: 'Fusion Miniaturization', era: 4, cost: { research: 350, rocketFuel: 120, orbitalInfra: 40 }, prerequisites: ['interplanetaryNav'], grantsEra: null, description: 'Miniaturized fusion reactors — triple energy and double fuel output', effects: [{ type: 'production_mult', target: 'energy', value: 3 }, { type: 'production_mult', target: 'rocketFuel', value: 2 }] },
  stellarArchitecture: { id: 'stellarArchitecture', name: 'Stellar Architecture', era: 7, cost: { megastructures: 15, stellarForge: 25, research: 500000 }, prerequisites: ['galacticAscendancy'], grantsEra: null, description: 'Design stellar-scale structures — x3 megastructures and x2 stellar forge', effects: [{ type: 'production_mult', target: 'megastructures', value: 3 }, { type: 'production_mult', target: 'stellarForge', value: 2 }] },
  voidNavigation: { id: 'voidNavigation', name: 'Void Navigation', era: 9, cost: { universalConstants: 20, cosmicPower: 50000, darkEnergy: 100000 }, prerequisites: ['realityScience'], grantsEra: null, description: 'Navigate the void between realities — x3 cosmic power and x2 reality fragments', effects: [{ type: 'production_mult', target: 'cosmicPower', value: 3 }, { type: 'production_mult', target: 'realityFragments', value: 2 }] },
  ...
  animalHusbandry: { id: 'animalHusbandry', name: 'Animal Husbandry', era: 1, cost: { food: 30, labor: 20, materials: 10 }, prerequisites: ['metallurgy'], grantsEra: null, description: 'Domesticate animals — double labor and triple food output', effects: [{ type: 'production_mult', target: 'labor', value: 2 }, { type: 'production_mult', target: 'food', value: 3 }] },
  semiconductorTheory: { id: 'semiconductorTheory', name: 'Semiconductor Theory', era: 2, cost: { research: 40, electronics: 35, steel: 40 }, prerequisites: ['advancedComputing'], grantsEra: null, description: 'Understand semiconductors — x3 electronics and x2 research', effects: [{ type: 'production_mult', target: 'electronics', value: 3 }, { type: 'production_mult', target: 'research', value: 2 }] },
  photonicsTheory: { id: 'photonicsTheory', name: 'Photonics', era: 3, cost: { research: 40, software: 30, data: 20 }, prerequisites: ['globalNetwork'], grantsEra: null, description: 'Light-based computing — x3 data and x2 electronics', effects: [{ type: 'production_mult', target: 'data', value: 3 }, { type: 'production_mult', target: 'electronics', value: 2 }] },
  warpFieldTheory: { id: 'warpFieldTheory', name: 'Warp Field Theory', era: 5, cost: { research: 3500, exoticMaterials: 120, energy: 25000 }, prerequisites: ['advancedPropulsion'], grantsEra: null, description: 'Theoretical warp fields — double exotic materials and triple energy', effects: [{ type: 'production_mult', target: 'exoticMaterials', value: 2 }, { type: 'production_mult', target: 'energy', value: 3 }] },
  galacticEcology: { id: 'galacticEcology', name: 'Galactic Ecology', era: 6, cost: { starSystems: 40, research: 25000, darkEnergy: 2000 }, prerequisites: ['galacticCartography'], grantsEra: null, description: 'Understand galactic ecosystems — x3 star systems and x2 colonies', effects: [{ type: 'production_mult', target: 'starSystems', value: 3 }, { type: 'production_mult', target: 'colonies', value: 2 }] },
  dimensionalPhysics: { id: 'dimensionalPhysics', name: 'Dimensional Physics', era: 8, cost: { exoticMatter: 1200, darkEnergy: 8000, research: 60000000 }, prerequisites: ['cosmicEngineering'], grantsEra: null, description: 'Physics of higher dimensions — x3 exotic matter and x2 cosmic power', effects: [{ type: 'production_mult', target: 'exoticMatter', value: 3 }, { type: 'production_mult', target: 'cosmicPower', value: 2 }] },

  // --- 6 new optional tech nodes ---
  geothermalEnergy: { id: 'geothermalEnergy', name: 'Geothermal Energy', era: 1, cost: { materials: 30, energy: 20, labor: 15 }, prerequisites: ['metallurgy'], grantsEra: null, description: 'Tap underground heat — triple energy and double materials output', effects: [{ type: 'production_mult', target: 'energy', value: 3 }, { type: 'production_mult', target: 'materials', value: 2 }] },
  microprocessorDesign: { id: 'microprocessorDesign', name: 'Microprocessor Design', era: 2, cost: { electronics: 45, research: 30, steel: 35 }, prerequisites: ['advancedComputing'], grantsEra: null, description: 'Design efficient chips — x3 research and x2 electronics', effects: [{ type: 'production_mult', target: 'research', value: 3 }, { type: 'production_mult', target: 'electronics', value: 2 }] },
  swarmIntelligence: { id: 'swarmIntelligence', name: 'Swarm Intelligence', era: 3, cost: { software: 40, data: 25, research: 50 }, prerequisites: ['globalNetwork'], grantsEra: null, description: 'Networked AI swarms — x3 software and x2 research', effects: [{ type: 'production_mult', target: 'software', value: 3 }, { type: 'production_mult', target: 'research', value: 2 }] },
  stellarMetallurgy: { id: 'stellarMetallurgy', name: 'Stellar Metallurgy', era: 7, cost: { stellarForge: 20, megastructures: 8, research: 350000 }, prerequisites: ['galacticAscendancy'], grantsEra: null, description: 'Forge metals in stars — x3 stellarForge and x2 materials', effects: [{ type: 'production_mult', target: 'stellarForge', value: 3 }, { type: 'production_mult', target: 'materials', value: 2 }] },
  cosmicResonance: { id: 'cosmicResonance', name: 'Cosmic Resonance', era: 9, cost: { cosmicPower: 60000, universalConstants: 50, darkEnergy: 150000 }, prerequisites: ['realityScience'], grantsEra: null, description: 'Resonate with cosmic frequencies — x3 cosmicPower and x3 universalConstants', effects: [{ type: 'production_mult', target: 'cosmicPower', value: 3 }, { type: 'production_mult', target: 'universalConstants', value: 3 }] },
  ...
  windmillDesign: { id: 'windmillDesign', name: 'Windmill Design', era: 1, cost: { materials: 28, energy: 22, labor: 12 }, prerequisites: ['metallurgy'], grantsEra: null, description: 'Efficient windmills — triple energy and double labor output', effects: [{ type: 'production_mult', target: 'energy', value: 3 }, { type: 'production_mult', target: 'labor', value: 2 }] },
  thermalDynamics: { id: 'thermalDynamics', name: 'Thermal Dynamics', era: 2, cost: { research: 35, steel: 40, electronics: 25 }, prerequisites: ['advancedComputing'], grantsEra: null, description: 'Mastery of heat transfer — x3 energy and x2 steel output', effects: [{ type: 'production_mult', target: 'energy', value: 3 }, { type: 'production_mult', target: 'steel', value: 2 }] },
  quantumEncryption: { id: 'quantumEncryption', name: 'Quantum Encryption', era: 3, cost: { software: 35, data: 25, research: 45 }, prerequisites: ['globalNetwork'], grantsEra: null, description: 'Unbreakable encryption — x3 software and x2 data output', effects: [{ type: 'production_mult', target: 'software', value: 3 }, { type: 'production_mult', target: 'data', value: 2 }] },
  gravityPlating: { id: 'gravityPlating', name: 'Gravity Plating', era: 4, cost: { research: 350, orbitalInfra: 40, rocketFuel: 100 }, prerequisites: ['interplanetaryNav'], grantsEra: null, description: 'Artificial gravity — x3 orbital infrastructure and x2 colonies', effects: [{ type: 'production_mult', target: 'orbitalInfra', value: 3 }, { type: 'production_mult', target: 'colonies', value: 2 }] },
  stellarNeuroscience: { id: 'stellarNeuroscience', name: 'Stellar Neuroscience', era: 7, cost: { stellarForge: 25, megastructures: 10, research: 400000 }, prerequisites: ['galacticAscendancy'], grantsEra: null, description: 'Map stellar neural networks — x3 research and x3 stellar forge', effects: [{ type: 'production_mult', target: 'research', value: 3 }, { type: 'production_mult', target: 'stellarForge', value: 3 }] },
  cosmicCartography: { id: 'cosmicCartography', name: 'Cosmic Cartography', era: 8, cost: { galacticInfluence: 50000, exoticMatter: 2000, starSystems: 15000 }, prerequisites: ['cosmicEngineering'], grantsEra: null, description: 'Map the cosmic web — x3 star systems and x2 galactic influence', effects: [{ type: 'production_mult', target: 'starSystems', value: 3 }, { type: 'production_mult', target: 'galacticInfluence', value: 2 }] },
  dimensionalResonance: { id: 'dimensionalResonance', name: 'Dimensional Resonance', era: 9, cost: { cosmicPower: 70000, universalConstants: 60, realityFragments: 20 }, prerequisites: ['realityScience'], grantsEra: null, description: 'Resonate across dimensions — x3 reality fragments and x3 universal constants', effects: [{ type: 'production_mult', target: 'realityFragments', value: 3 }, { type: 'production_mult', target: 'universalConstants', value: 3 }] },

  // --- 6 new optional tech nodes ---
  aqueductEngineering: { id: 'aqueductEngineering', name: 'Aqueduct Engineering', era: 1, cost: { materials: 35, labor: 25, food: 20 }, prerequisites: ['metallurgy'], grantsEra: null, description: 'Roman-style aqueducts triple food and double energy output', effects: [{ type: 'production_mult', target: 'food', value: 3 }, { type: 'production_mult', target: 'energy', value: 2 }] },
  industrialChemistry: { id: 'industrialChemistry', name: 'Industrial Chemistry', era: 2, cost: { research: 45, steel: 50, electronics: 30 }, prerequisites: ['advancedComputing'], grantsEra: null, description: 'Chemical processes triple steel and double materials output', effects: [{ type: 'production_mult', target: 'steel', value: 3 }, { type: 'production_mult', target: 'materials', value: 2 }] },
  biocomputing: { id: 'biocomputing', name: 'Biocomputing', era: 3, cost: { software: 45, data: 30, research: 55 }, prerequisites: ['globalNetwork'], grantsEra: null, description: 'Biological processors — x3 software and x2 research output', effects: [{ type: 'production_mult', target: 'software', value: 3 }, { type: 'production_mult', target: 'research', value: 2 }] },
  solarForge: { id: 'solarForge', name: 'Solar Forge', era: 5, cost: { research: 4500, exoticMaterials: 140, energy: 22000 }, prerequisites: ['advancedPropulsion'], grantsEra: null, description: 'Forge materials in solar fire — triple exoticMaterials and double energy', effects: [{ type: 'production_mult', target: 'exoticMaterials', value: 3 }, { type: 'production_mult', target: 'energy', value: 2 }] },
  hyperspaceFolding: { id: 'hyperspaceFolding', name: 'Hyperspace Folding', era: 6, cost: { darkEnergy: 3500, research: 35000, starSystems: 120 }, prerequisites: ['galacticCartography'], grantsEra: null, description: 'Fold hyperspace for instant travel — x3 dark energy and x3 star systems', effects: [{ type: 'production_mult', target: 'darkEnergy', value: 3 }, { type: 'production_mult', target: 'starSystems', value: 3 }] },
  gravimetricLensing: { id: 'gravimetricLensing', name: 'Gravimetric Lensing', era: 8, cost: { exoticMatter: 2500, galacticInfluence: 70000, research: 70000000 }, prerequisites: ['cosmicEngineering'], grantsEra: null, description: 'Bend spacetime to observe distant galaxies — x3 galactic influence and x2 exotic matter', effects: [{ type: 'production_mult', target: 'galacticInfluence', value: 3 }, { type: 'production_mult', target: 'exoticMatter', value: 2 }] },

  // --- 8 new optional tech nodes ---
  mineralogy: { id: 'mineralogy', name: 'Mineralogy', era: 1, cost: { materials: 32, labor: 18, energy: 15 }, prerequisites: ['metallurgy'], grantsEra: null, description: 'Study mineral composition — triple materials and double energy output', effects: [{ type: 'production_mult', target: 'materials', value: 3 }, { type: 'production_mult', target: 'energy', value: 2 }] },
  electromagnetism: { id: 'electromagnetism', name: 'Electromagnetism', era: 2, cost: { research: 40, electronics: 40, steel: 30 }, prerequisites: ['advancedComputing'], grantsEra: null, description: 'Master electromagnetic theory — x3 electronics and x2 energy', effects: [{ type: 'production_mult', target: 'electronics', value: 3 }, { type: 'production_mult', target: 'energy', value: 2 }] },
  holographicStorage: { id: 'holographicStorage', name: 'Holographic Storage', era: 3, cost: { data: 35, software: 40, research: 50 }, prerequisites: ['globalNetwork'], grantsEra: null, description: 'Store data in holograms — x3 data and x2 software', effects: [{ type: 'production_mult', target: 'data', value: 3 }, { type: 'production_mult', target: 'software', value: 2 }] },
  nuclearPropulsion: { id: 'nuclearPropulsion', name: 'Nuclear Propulsion', era: 4, cost: { research: 380, rocketFuel: 130, orbitalInfra: 45 }, prerequisites: ['interplanetaryNav'], grantsEra: null, description: 'Nuclear thermal rockets — triple fuel and double orbital infra', effects: [{ type: 'production_mult', target: 'rocketFuel', value: 3 }, { type: 'production_mult', target: 'orbitalInfra', value: 2 }] },
  stellarEcology: { id: 'stellarEcology', name: 'Stellar Ecology', era: 5, cost: { research: 4200, colonies: 20, exoticMaterials: 130 }, prerequisites: ['advancedPropulsion'], grantsEra: null, description: 'Understand stellar ecosystems — triple colonies and double exotic materials', effects: [{ type: 'production_mult', target: 'colonies', value: 3 }, { type: 'production_mult', target: 'exoticMaterials', value: 2 }] },
  neutroniomAlloy: { id: 'neutroniomAlloy', name: 'Neutroniom Alloy', era: 6, cost: { darkEnergy: 4000, starSystems: 80, research: 28000 }, prerequisites: ['galacticCartography'], grantsEra: null, description: 'Forge neutronium alloy — x3 dark energy and x2 exotic materials', effects: [{ type: 'production_mult', target: 'darkEnergy', value: 3 }, { type: 'production_mult', target: 'exoticMaterials', value: 2 }] },
  chronoEngineering: { id: 'chronoEngineering', name: 'Chrono-Engineering', era: 7, cost: { stellarForge: 30, megastructures: 14, research: 450000 }, prerequisites: ['galacticAscendancy'], grantsEra: null, description: 'Engineer across timelines — x3 megastructures and x3 stellar forge', effects: [{ type: 'production_mult', target: 'megastructures', value: 3 }, { type: 'production_mult', target: 'stellarForge', value: 3 }] },
  entanglementNetwork: { id: 'entanglementNetwork', name: 'Entanglement Network', era: 8, cost: { exoticMatter: 2000, galacticInfluence: 60000, research: 65000000 }, prerequisites: ['cosmicEngineering'], grantsEra: null, description: 'Quantum entanglement across galaxies — x3 exotic matter and x3 galactic influence', effects: [{ type: 'production_mult', target: 'exoticMatter', value: 3 }, { type: 'production_mult', target: 'galacticInfluence', value: 3 }] },

  // --- 6 new optional tech nodes ---
  fermentation: { id: 'fermentation', name: 'Fermentation', era: 1, cost: { food: 28, labor: 18, materials: 12 }, prerequisites: ['metallurgy'], grantsEra: null, description: 'Fermented foods preserve longer — triple food and double labor', effects: [{ type: 'production_mult', target: 'food', value: 3 }, { type: 'production_mult', target: 'labor', value: 2 }] },
  polymers: { id: 'polymers', name: 'Polymer Science', era: 2, cost: { research: 42, steel: 38, electronics: 28 }, prerequisites: ['advancedComputing'], grantsEra: null, description: 'Synthetic polymers revolutionize manufacturing — x3 steel and x2 materials', effects: [{ type: 'production_mult', target: 'steel', value: 3 }, { type: 'production_mult', target: 'materials', value: 2 }] },
  machineVision: { id: 'machineVision', name: 'Machine Vision', era: 3, cost: { data: 28, software: 35, research: 42 }, prerequisites: ['globalNetwork'], grantsEra: null, description: 'Machines that see and understand — x3 data and x2 electronics', effects: [{ type: 'production_mult', target: 'data', value: 3 }, { type: 'production_mult', target: 'electronics', value: 2 }] },
  spaceMining: { id: 'spaceMining', name: 'Space Mining', era: 4, cost: { research: 360, rocketFuel: 140, orbitalInfra: 42 }, prerequisites: ['interplanetaryNav'], grantsEra: null, description: 'Mine asteroids industrially — x3 materials and x2 exotic materials', effects: [{ type: 'production_mult', target: 'materials', value: 3 }, { type: 'production_mult', target: 'exoticMaterials', value: 2 }] },
  dysonTheory: { id: 'dysonTheory', name: 'Dyson Theory', era: 5, cost: { research: 4800, exoticMaterials: 160, energy: 28000 }, prerequisites: ['advancedPropulsion'], grantsEra: null, description: 'Theoretical framework for Dyson structures — x3 energy and x2 colonies', effects: [{ type: 'production_mult', target: 'energy', value: 3 }, { type: 'production_mult', target: 'colonies', value: 2 }] },
  temporalShielding: { id: 'temporalShielding', name: 'Temporal Shielding', era: 7, cost: { stellarForge: 28, megastructures: 12, research: 420000 }, prerequisites: ['galacticAscendancy'], grantsEra: null, description: 'Shield against temporal distortions — x3 stellarForge and x2 darkEnergy', effects: [{ type: 'production_mult', target: 'stellarForge', value: 3 }, { type: 'production_mult', target: 'darkEnergy', value: 2 }] },
};
