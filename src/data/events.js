...
export const events = {
  ...
  storyStrangeMetal: { id: 'storyStrangeMetal', name: 'Strange Metal in the Soil', description: 'A work crew pulls something from the mud — an alloy too uniform to be natural, too corroded to be from the ship. The soil here is threaded with it, like veins in flesh.', minEra: 1, chance: 0.006, type: 'instant', effect: { resourceId: 'materials', amount: 25 } },
  storyGeometricRock: { id: 'storyGeometricRock', name: 'Geometric Patterns', description: 'A cliff face collapses, revealing hexagonal basalt columns — except they aren\'t basalt. The angles are too precise. Someone carved these, then buried them under a mountain.', minEra: 1, chance: 0.006, type: 'instant', effect: { resourceId: 'materials', amount: 20 } },
  ...
  storyTerraformScars: { id: 'storyTerraformScars', name: 'Terraform Scars', description: 'The neighboring planet bears the unmistakable scars of terraforming — atmospheric processors rusting on plateaus, canal systems choked with red dust. Someone tried to make this world green. The timeline puts it at fifty thousand years ago.', minEra: 5, chance: 0.006, type: 'instant', effect: { resourceId: 'colonies', amount: 8 } },
  storyAbandonedBelongings: { id: 'storyAbandonedBelongings', name: 'Abandoned Belongings', description: 'The colony dome is pressurized. Inside: personal effects. A child\'s drawing of two suns. A journal in an unknown script. A photograph — faded, cracked — of a family standing in front of this exact dome. In the background, your ship, landing.', minEra: 5, chance: 0.006, type: 'instant', effect: { resourceId: 'exoticMaterials', amount: 40 } },
  storyMatchingStarMap: { id: 'storyMatchingStarMap', name: 'The Matching Star Map', description: 'The ancient star map is perfect — every system cataloged, every resource noted, every route plotted. Your expansion plan, drafted by committee last year, matches it point for point. The map is dated. It\'s from the next cycle.', minEra: 5, chance: 0.006, type: 'instant', effect: { resourceId: 'exoticMaterials', amount: 50 } },

  // Era 6: Interstellar — Ancient beacons, dead civilizations, familiar coordinates
  storyEchoingBeacon: { id: 'storyEchoingBeacon', name: 'Echoing Beacon', description: 'An ancient FTL beacon activates as you approach. Its signal predates your arrival by millennia — but it\'s broadcasting your ship\'s transponder code.', minEra: 6, chance: 0.006, type: 'instant', effect: { resourceId: 'starSystems', amount: 50 } },
  storyStarGraveyard: { id: 'storyStarGraveyard', name: 'Star Graveyard', description: 'A cluster of dead stars, each surrounded by debris that was once a civilization. Every one reached exactly this stage of development.', minEra: 6, chance: 0.006, type: 'instant', effect: { resourceId: 'darkEnergy', amount: 200 } },
  storyFamiliarCoordinates: { id: 'storyFamiliarCoordinates', name: 'Familiar Coordinates', description: 'The navigation computer flags an anomaly — the ancient star maps don\'t just show where civilizations were. They show where you\'re going next.', minEra: 6, chance: 0.006, type: 'instant', effect: { resourceId: 'galacticInfluence', amount: 80 } },

  // Era 7: Dyson Era — Mirror sphere, stellar archive, resonance cascade
  storyMirrorSphere: { id: 'storyMirrorSphere', name: 'Mirror Sphere', description: 'The abandoned Dyson sphere\'s control interface accepts your authentication codes. It was built by hands with the same fingerprints as yours.', minEra: 7, chance: 0.006, type: 'instant', effect: { resourceId: 'megastructures', amount: 15 } },
  storyStellarArchive: { id: 'storyStellarArchive', name: 'Stellar Archive', description: 'Inside the sphere, a library of stellar engineering data. The last entry reads: \'If you are reading this, you are us. Do not build the Engine.\'', minEra: 7, chance: 0.006, type: 'instant', effect: { resourceId: 'stellarForge', amount: 100 } },
  storyResonanceCascade: { id: 'storyResonanceCascade', name: 'Resonance Cascade', description: 'Your stellar forge resonates with frequencies from the ancient sphere. For a moment, both activate simultaneously across a million years.', minEra: 7, chance: 0.006, type: 'instant', effect: { resourceId: 'stellarForge', amount: 150 } },

  // Era 8: Galactic — Senate of ghosts, convergence signal, memory plague
  storySenateOfGhosts: { id: 'storySenateOfGhosts', name: 'Senate of Ghosts', description: 'The galactic senate chamber has seats for every species that ever achieved interstellar travel. Every seat is empty. Every nameplate reads the same word in different languages: \'Again.\'', minEra: 8, chance: 0.006, type: 'instant', effect: { resourceId: 'galacticInfluence', amount: 300 } },
  storyConvergenceSignal: { id: 'storyConvergenceSignal', name: 'Convergence Signal', description: 'Every galaxy in the local cluster is broadcasting the same signal: a countdown. It started before any civilization existed. It ends... soon.', minEra: 8, chance: 0.006, type: 'instant', effect: { resourceId: 'exoticMatter', amount: 150 } },
  storyMemoryPlague: { id: 'storyMemoryPlague', name: 'Memory Plague', description: 'Crew members report dreams of lives they never lived — building civilizations on planets they\'ve never seen. The dreams are memories. Not theirs.', minEra: 8, chance: 0.006, type: 'instant', effect: { resourceId: 'exoticMatter', amount: 120 } },

  // Era 9: Intergalactic — The counter, void whisper, pattern recognition
  storyTheCounter: { id: 'storyTheCounter', name: 'The Counter', description: 'Deep in the cosmic web, an ancient machine counts. It displays: \'7,832,040,991\'. As you watch, it increments by one.', minEra: 9, chance: 0.006, type: 'instant', effect: { resourceId: 'cosmicPower', amount: 300 } },
  storyVoidWhisper: { id: 'storyVoidWhisper', name: 'Void Whisper', description: 'Between galaxies, where nothing should exist, a voice transmits in your language: \'You always get this far. You never get further.\'', minEra: 9, chance: 0.006, type: 'instant', effect: { resourceId: 'universalConstants', amount: 25 } },
  storyPatternRecognition: { id: 'storyPatternRecognition', name: 'Pattern Recognition', description: 'Your scientists overlay the cosmic microwave background with the expansion pattern of every civilization ever detected. They match perfectly. The universe is the blueprint.', minEra: 9, chance: 0.006, type: 'instant', effect: { resourceId: 'cosmicPower', amount: 250 } },

  // Era 10: Multiverse — Mirror self, archive complete, final transmission
  storyMirrorSelf: { id: 'storyMirrorSelf', name: 'Mirror Self', description: 'Through a dimensional rift, you see yourself. Not a copy — you. Making the same decisions. Building the same things. About to prestige.', minEra: 10, chance: 0.006, type: 'instant', effect: { resourceId: 'realityFragments', amount: 100 } },
  storyTheArchiveComplete: { id: 'storyTheArchiveComplete', name: 'The Archive Complete', description: 'Every piece of data you\'ve collected across every reality assembles into one truth: there is no beginning. There is no end. There is only the cycle.', minEra: 10, chance: 0.006, type: 'instant', effect: { resourceId: 'quantumEchoes', amount: 50 } },
  storyFinalTransmission: { id: 'storyFinalTransmission', name: 'Final Transmission', description: 'A message from the next iteration arrives before you send it: \'We tried to break the cycle too. See you on the other side.\'', minEra: 10, chance: 0.006, type: 'instant', effect: { resourceId: 'realityFragments', amount: 150 } },
};
