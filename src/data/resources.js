...
export const resources = {
  ...
  // Era 4: Space Age — small base rate to help bootstrapping
  rocketFuel: { id: 'rocketFuel', name: 'Rocket Fuel', era: 4, baseCap: 5000, baseRate: 0.1, description: 'Propellant for rockets' },
  orbitalInfra: { id: 'orbitalInfra', name: 'Orbital Infrastructure', era: 4, baseCap: 1000, baseRate: 0.05, description: 'Structures in orbit' },
